  ...
  return (
    <div className="max-w-2xl p-6 font-sans text-gray-900">
      ...
      <p className="mb-5 text-sm text-gray-500">
        A curated directory of companies, separate from the free-text company name on each crawled job. Link a job to a company from the
        Jobs page. Deleting a company un-links its jobs — it never deletes them.
      </p>
