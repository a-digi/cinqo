      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mb-5 text-sm text-gray-500">
            Domains the Browser tool can log into on your behalf. The AI can ask whether a credential exists for a domain, but never sees
            the username or password stored here.
          </p>
        </div>
        <button
          type="button"
