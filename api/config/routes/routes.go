...
func Init(ctx serverdi.Context) {
	...
	handlerMap := map[string]routing.HandlerInterface{
		...
		"ConversationGetTurnSubAgents": local_routing.HandlerFunc(conversation_handler.GetTurnSubAgentsHandler),
		...
		"MediaUploadImage":  local_routing.HandlerFunc(media_handler.UploadImageHandler),
		"MediaReplaceImage": local_routing.HandlerFunc(media_handler.ReplaceImageHandler),
